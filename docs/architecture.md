...
## 3. Modular Agent Sub-Package Directory Architecture
...
│
├── specialized/                       # 2. AUTONOMOUS REASONING AGENTS
...
│
├── nodes/                             # 3. PIPELINE GRAPH EXECUTION NODES
...
## 4. Canonical Domain Schemas

### CanonicalOrder
- `order_id`: Primary order identifier string (e.g. `ORD-1001`, `Sub Order No`)
- `sku`: Product SKU ID
...
## 5. Deterministic P&L Formula Specification

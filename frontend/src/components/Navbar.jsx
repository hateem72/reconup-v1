      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-base font-extrabold tracking-tight text-slate-900 flex items-center gap-1.5">
                FINANCE<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">CONTROLLER.AI</span>
              </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl text-xs font-bold bg-blue-600 hover:bg-blue-700 text-white shadow-md shadow-blue-500/20 flex items-center gap-2 transition disabled:opacity-50"
          >
          ...
          <button
            onClick={onHardReset}
            disabled={isProcessing}
            className="px-3 py-2 rounded-xl text-xs font-semibold bg-rose-50 hover:bg-rose-100 text-rose-700 border border-rose-200 flex items-center gap-1.5 transition disabled:opacity-50"

    ...
    <div className="rounded-2xl bg-slate-900 border border-slate-800 p-6 shadow-2xl space-y-6">
      <div className="flex items-center justify-between border-b border-slate-800 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base font-extrabold text-white">Step 2: AI Sheet Relevance Evaluation</h2>
            <p className="text-xs text-slate-400">
              Autonomous Agent <strong className="text-cyan-300">SheetRelevanceAgent</strong> evaluates workbooks & drops non-essential tabs
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 rounded-xl bg-slate-950 border border-emerald-500/30 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-emerald-300 font-bold">RETAINED ✓</span>
          </div>
          <p className="text-xs text-slate-400">
        ...
        <div className="p-4 rounded-xl bg-slate-950 border border-rose-500/30 space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs font-mono text-rose-300 font-bold">DROPPED ✂️</span>
          </div>
          <p className="text-xs text-slate-400">
            Ad cost summaries, referral text notes, disclaimer headers, or empty tabs without order transaction records.
          </p>
          <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 text-xs font-mono space-y-1.5 text-slate-400">
